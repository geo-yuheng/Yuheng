...
class TestLoadNetwork(unittest.TestCase):
    ...
    def test_load_network_single_element(self):
        ...
        assert m_local.way_dict[28814809].tags == m_network.way_dict[28814809].tags
        assert m_local.way_dict[28814809].changeset == m_network.way_dict[28814809].changeset
        assert m_local.way_dict[28814809].timestamp == m_network.way_dict[28814809].timestamp
